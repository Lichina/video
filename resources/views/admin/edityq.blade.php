                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" value="{{$id}}" name="yqid">
                                <input type="text" class="form-control" id="field-1" value="{{$yq['yqname']}}" name="yqname" placeholder="请输入友链名称" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-3" name="yqlink" value="{{$yq['yqlink']}}" placeholder="请输入友链地址" required>
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                        <div class="form-group">
            ...
            $('#submit').click(function () {
                ...
                $.ajax({
                    ...
                    success: function (resp){
                        if(resp.status==200){
                            layer.msg(resp.msg);
                            window.location = '/{{$webset['webdir']}}/yqlinklist'
                        }
                        else {
                            layer.msg(resp.msg)
                        }
