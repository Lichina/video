                ...
                <li class="@yield('set')">
                    ...
                    <ul>
                        <li class="@yield('webset')">
                            <a href="/{{$webset['webdir']}}/webset">
                                <span class="title">基本设置</span>
                            </a>
                        </li>
                        <li class="@yield('jkset')">
                            <a href="/{{$webset['webdir']}}/jkset">
                ...
                <li class="@yield('banner')">
                    ...
                    <ul>
                        <li class="@yield('bannerlist')">
                            <a href="/{{$webset['webdir']}}/bannerlist">
                                <span class="title">轮播列表</span>
                            </a>
                        </li>
                        <li class="@yield('addbanner')">
                            <a href="/{{$webset['webdir']}}/addbanner">
                ...
                <li class="@yield('nav')">
                    ...
                    <ul>
                        <li class="@yield('navlist')">
                            <a href="/{{$webset['webdir']}}/navlist">
                                <span class="title">导航列表</span>
                            </a>
                        </li>
                        <li class="@yield('addnav')">
                            <a href="/{{$webset['webdir']}}/addnav">
                ...
                <li class="@yield('new')">
                    ...
                    <ul>
                        <li class="@yield('newlist')">
                            <a href="/{{$webset['webdir']}}/newmovielist">
                                <span class="title">尝鲜列表</span>
                            </a>
                        </li>
                        <li class="@yield('addnew')">
                            <a href="/{{$webset['webdir']}}/addnewmovie">
                ...
                <li class="@yield('zb')">
                    ...
                    <ul>
                        <li class="@yield('zblist')">
                            <a href="/{{$webset['webdir']}}/zblist">
                                <span class="title">直播列表</span>
                            </a>
                        </li>
                        <li class="@yield('addzb')">
                            <a href="/{{$webset['webdir']}}/addzb">
                ...
                <li class="@yield('yq')">
                    ...
                    <ul>
                        <li class="@yield('yqlist')">
                            <a href="/{{$webset['webdir']}}/yqlinklist">
                                <span class="title">友链列表</span>
                            </a>
                        </li>
                        <li class="@yield('addyq')">
                            <a href="/{{$webset['webdir']}}/addyqlink">
                ...
                <li class="@yield('qq')">
                    ...
                    <ul>
                        <li class="@yield('qqlist')">
                            <a href="/{{$webset['webdir']}}/qqlist">
                                <span class="title">侵权列表</span>
                            </a>
                        </li>
                        <li class="@yield('addqq')">
                            <a href="/{{$webset['webdir']}}/addqq">
                ...
                <li class="@yield('security')">
                    ...
                    <ul>
                        <li class="@yield('ccdefense')">
                            <a href="/{{$webset['webdir']}}/ccdefense">
