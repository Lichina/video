                    ...
                    <div class="item">
                        <ul class="clearfix">
                           ...
                           <div class="col-md-2 col-sm-3 col-xs-4">
							<a target="_blank" class="videopic lazy xwcms" href="/play/{{$dm['url']}}.html" title="{{$dm['title']}}" src="{{$dm['img']}}" onclick="jilu(this)" style="background: url({{$dm['img']}}) no-repeat; background-position:50% 50%; background-size: cover;border-radius: 5px;"><span class="play hidden-xs"></span><span class="score">{{$dm['js']}}</span></a>
							<div class="title">
