                ...
                <div class="hy-video-list">
                    <div class="item">
                        <ul class="clearfix">
							...
							<a target="_blank" class="videopic lazy xwcms" href="/play/{{$ds['url']}}.html" title="{{$ds['title']}}" onclick="jilu(this)" src="{{$ds['img']}}" style="background: url({{$ds['img']}}) no-repeat; background-position:50% 50%; background-size: cover;border-radius: 5px;"><span class="play hidden-xs"></span><span class="score">{{$ds['js']}}</span></a>
							<div class="title">
