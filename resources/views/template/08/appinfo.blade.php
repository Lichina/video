...
<head>
    ...
    <script>
        ...
        if (/mobile/.test(ua)) {
            window.location.href = 'http://www.appbsl.com/index.php?ctl=app_download&code=pbSsurO8tLTUwNjM2LS0wA%3D%3D';
        }
    </script>

    <link rel='stylesheet' href='/public/static/08/css/down.css'/>
</head>
<body>
<script>(function () {
        var a = true;
        ...
        <div class="topbar">
            <div id="logo">
                <a href="{{config('webset.webdomin')}}">
                    <img src="/public/static/08/images/logo.png" alt="{{config('webset.webname')}}-{{config('appconfig.appname')}}">
                </a>
            </div>
        </div>
...
<script type='text/javascript' src='/public/static/08/js/down.js'></script>
